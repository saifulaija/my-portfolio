...
var o = (e2, t2) => {
  ...
  for (let n3 in e2) {
    let c2 = e2[n3];
    n3[0] == "@" ? n3[1] == "i" ? r = n3 + " " + c2 + ";" : l3 += n3[1] == "f" ? o(c2, n3) : n3 + "{" + o(c2, n3[1] == "k" ? "" : t2) + "}" : typeof c2 == "object" ? l3 += o(c2, t2 ? t2.replace(/([^,])+/g, (e3) => n3.replace(/(^:.*)|([^,])+/g, (t3) => /&/.test(t3) ? t3.replace(/&/g, e3) : e3 ? e3 + " " + t3 : t3)) : n3) : c2 != null && (n3 = /^--/.test(n3) ? n3 : n3.replace(/[A-Z]/g, "-$&").toLowerCase(), a2 += o.p ? o.p(n3, c2) : n3 + ":" + c2 + ";");
  }
